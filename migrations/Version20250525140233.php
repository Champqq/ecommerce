...
final class Version20250525140233 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        $this->addSql(
            ...
            CREATE TABLE product_categories (
                ...
                INDEX IDX_A99419434584665A (product_id),
                INDEX IDX_A994194312469DE2 (category_id),
        ...
        $this->addSql(
            ...
            ALTER TABLE product_categories
                ADD CONSTRAINT FK_A99419434584665A
        ...
        $this->addSql(
            <<<'SQL'
            ALTER TABLE product_categories
                ADD CONSTRAINT FK_A994194312469DE2
    ...
    public function down(Schema $schema): void
    {
        $this->addSql(
            <<<'SQL'
            ALTER TABLE product_categories
                DROP FOREIGN KEY FK_A99419434584665A
        SQL
        );
        $this->addSql(
            <<<'SQL'
            ALTER TABLE product_categories
                DROP FOREIGN KEY FK_A994194312469DE2
        SQL
        );
        $this->addSql(
            <<<'SQL'
        ...
        $this->addSql(
            <<<'SQL'
            ALTER TABLE `order`
                DROP FOREIGN KEY FK_F5299398A76ED395
        SQL
        );
        $this->addSql(
            <<<'SQL'
        ...
        $this->addSql(
            <<<'SQL'
            ALTER TABLE product_attribute
                DROP FOREIGN KEY FK_94DA59764584665A
        SQL
        );
        $this->addSql(
            <<<'SQL'
